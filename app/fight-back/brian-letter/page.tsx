...
export default function BrianLetter() {
  return (
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <article style={{ padding: "5rem 2rem 3rem", maxWidth: "680px" }}>
          ...
          <div style={{ fontSize: "16px", lineHeight: 1.9, color: "#444441", fontWeight: 300 }}>
            ...
            <p style={{ marginBottom: "1rem", fontWeight: 500, color: "#2C2C2A" }}>What actually goes wrong</p>
            ...
            <p style={{ marginBottom: "1rem", fontWeight: 500, color: "#2C2C2A" }}>The daily card</p>
            ...
            <p style={{ marginBottom: "1rem", fontWeight: 500, color: "#2C2C2A" }}>The text to you</p>
            ...
            <p style={{ marginBottom: "1rem", fontWeight: 500, color: "#2C2C2A" }}>The reminder layer</p>
            ...
            <div style={{ background: "#F5F0E8", borderRadius: "8px", padding: "1.5rem", margin: "2rem 0" }}>
              ...
              {[
                { time: "7:30am", text: '"Good morning Casey. Medications first. Then write your morning card."' },
                { time: "12:00pm", text: '"It\'s noon. Eat something good. Not just chips."' },
                { time: "6:00pm", text: '"Dinner time. Same rule applies."' },
                { time: "9:00pm", text: '"Night medication. Don\'t skip it."' },
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", gap: "1rem", marginBottom: "0.5rem" }}>
                  <span style={{ fontSize: "14px", fontWeight: 500, color: "#2C2C2A", minWidth: "60px", flexShrink: 0 }}>{item.time}</span>
                  <span style={{ fontSize: "14px", color: "#5F5E5A", lineHeight: 1.6 }}>{item.text}</span>
                </div>
              ))}
              <p style={{ fontSize: "14px", color: "#5F5E5A", lineHeight: 1.7, marginTop: "0.75rem" }}>
            ...
            <p style={{ marginBottom: "1.5rem" }}>That&apos;s the whole system. Now you have it.</p>

            <p style={{ marginBottom: "0.5rem" }}>I love you.</p>

            <p style={{ marginBottom: "2.5rem", fontStyle: "italic" }}>— Dad</p>
        ...
        <JoinCTA message="The families that handle this well are the ones who had the conversation before the crisis." />
      </div>
      <Footer />
    </main>
  );
