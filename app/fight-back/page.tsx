...
export default function FightBack() {
  useEffect(() => {
    ...
    script.src = "https://www.buzzsprout.com/2615249/episodes/19118579-the-caregiver-s-trap-advocacy-and-fighting-back.js?container_id=buzzsprout-player-19118579&player=small";
    ...
    <main style={{ fontFamily: "'Inter', sans-serif", background: "#FDFAF6", color: "#2C2C2A", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <section style={{ padding: "0 2rem 2rem", maxWidth: "680px" }}>
          ...
          <p style={{ fontSize: "13px", color: "#888780", marginBottom: "1rem", fontStyle: "italic" }}>A 20-minute audio summary of Fight Back — updated as new articles are added.</p>
          <div id="buzzsprout-player-19118579"></div>
        </section>
