...
export default function TheLonelyChapter() {
  return (
    <main style={{ fontFamily: "'Inter', sans-serif", background: "#FDFAF6", color: "#2C2C2A", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "680px", margin: "0 auto", padding: "5rem 2rem 4rem" }}>
        ...
        <p style={{ fontSize: "19px", fontFamily: "'Lora', serif", fontStyle: "italic", lineHeight: 1.7, color: "#5F5E5A", marginBottom: "3rem" }}>
          The gap between the old life and the new one — and what to do with it.
        </p>

        <div style={{ fontSize: "17px", lineHeight: 1.9, color: "#3a3a38", fontWeight: 300 }}>
          ...
          <p style={{ marginBottom: "1.5rem" }}>Someone said recently: &ldquo;If you&apos;re not willing to be lonely for a period of time, you&apos;ll never become who you&apos;re capable of becoming.&rdquo;</p>
          ...
          <p style={{ marginBottom: "1.5rem" }}>Get in the water.</p>
        </div>

        <div style={{ marginTop: "4rem", paddingTop: "2rem", borderTop: "0.5px solid #D3D1C7" }}>
          <a href="/after" style={{ fontSize: "13px", color: "#BA7517", textDecoration: "none" }}>← Back to After</a>
        </div>
      </div>
