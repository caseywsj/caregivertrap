...
export default function TheCamera() {
  return (
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <article style={{ padding: "5rem 2rem 3rem", maxWidth: "680px" }}>
          ...
          <div style={{ fontSize: "16px", lineHeight: 1.9, color: "#444441", fontWeight: 300 }}>
            ...
            <p style={{ marginBottom: "1.5rem" }}>And there was Lonna.</p>
            ...
            <p style={{ marginBottom: "1.5rem" }}>Waiting for me to help her up.</p>
            ...
            <p style={{ marginBottom: "1.5rem" }}>It will be exactly the thing you didn&apos;t see coming.</p>
            ...
            <p style={{ marginBottom: "1.5rem" }}>For twenty-five years, that was me.</p>
            ...
            <p style={{ marginBottom: "2.5rem" }}>That&apos;s enough.</p>
        ...
        <JoinCTA message="Grief ambushes you. It will be exactly the thing you didn't see coming." />
      </div>
      <Footer />
    </main>
  );
